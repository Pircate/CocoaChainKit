...
public extension Chain where Base: UINavigationBar {
    ...
    @discardableResult
    func titleTextAttributes(_ titleTextAttributes: [AttributedStringKey : Any]?) -> Chain {
    ...
    @discardableResult
    func largeTitleTextAttributes(_ largeTitleTextAttributes: [AttributedStringKey : Any]?) -> Chain {
        if #available(iOS 11.0, *) {
